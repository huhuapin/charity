            ...
            <div class="layui-col-md6 layui-col-md-offset3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body" style="padding: 15px;">
                        <form class="layui-form" action="${pageContext.request.contextPath}/authority/addApplication" method="post" lay-filter="component-form-group">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="doneeId" lay-search>
                                        <option value="0" selected>群体</option>
                                        <c:forEach items="${donees}" var="donee">
                                            <option value="${donee.get("id")}">${donee.get("name")}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" lay-filter="urgent" name="urgent"  title="否" value="0"  checked >
                                    <input type="radio" lay-filter="urgent" name="urgent"  title="是" value="1">
                                </div>
                            </div>
                            <div class="layui-form-item">
