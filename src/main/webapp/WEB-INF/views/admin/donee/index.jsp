        ...
        <div class="layui-fluid">
            <div class="layui-row layui-col-space15">
                ...
                <div class="layui-col-sm6 layui-col-md3">
                    ...
                    <div class="layui-card-header">
                        慈善机构
                        <span class="layui-badge layui-bg-green layuiadmin-badge">机构</span>
                    </div>
                    <div class="layui-card-body layuiadmin-card-list">
                        <p class="layuiadmin-big-font"><a href="${pageContext.request.contextPath}/authority_detail?id=${authority.id}">${authorityName}</a></p>
                        <p>
                            所在慈善机构
                        </p>
                    </div>
                ...
                <div class="layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body layuiadmin-card-list">
                            <p class="layuiadmin-big-font">${num}</p>
                            <p>
                                捐赠申请数
                            </p>
                        </div>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">近七日受赠金额</div>
