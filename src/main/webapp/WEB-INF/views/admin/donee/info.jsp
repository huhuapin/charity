                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" pad15>
                            <form action="${pageContext.request.contextPath}/donee/setInfo" method="post" class="layui-form" lay-filter="">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="radio" name="sex" value="0" title="男" <c:if test="${object.sex == 0 || object.sex==null}"> checked </c:if> >
                                ...
                                <div class="layui-form-item">
                                    <label class="layui-form-label">慈善机构</label>
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" value="${authorityName}" disabled>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">自我介绍</label>
                                    <div class="layui-input-inline">
                                        <textarea name="description" class="layui-textarea">${object.description}</textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
